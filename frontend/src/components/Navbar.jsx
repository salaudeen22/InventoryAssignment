  ...
  return (
    <div className="nav flex justify-between items-center  px-4 py-3 shadow-md rounded-lg md:px-20">
      ...
      <div className="navLinks hidden md:flex items-center space-x-8 text-lg font-medium">
        <h3 className="hover:text-yellow-300 transition-colors duration-300 cursor-pointer">Home</h3>
        <h3 className="hover:text-yellow-300 transition-colors duration-300 cursor-pointer">All Items</h3>
        <h3 className="hover:text-yellow-300 transition-colors duration-300 cursor-pointer">Item Groups</h3>
      </div>
